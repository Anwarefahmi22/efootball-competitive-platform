...
(function () {
  ...
  const translations = {
    ...
    // Admin dispute review (interface labels only)
    "لوحة الإدارة — eFootball Arena": { fr: "Console d'administration — eFootball Arena", en: "Admin console — eFootball Arena" },
    "مراجعة النزاعات": { fr: "Examen des litiges", en: "Dispute review" },
    "النزاعات المفتوحة": { fr: "Litiges ouverts", en: "Open disputes" },
    "النزاعات المحسومة": { fr: "Litiges tranchés", en: "Resolved disputes" },
    "كل النزاعات": { fr: "Tous les litiges", en: "All disputes" },
    "تحديث القائمة": { fr: "Actualiser la liste", en: "Refresh the list" },
    "هذه الصفحة مخصّصة لمشرفي المنصة فقط.": { fr: "Cette page est réservée aux modérateurs de la plateforme.", en: "This page is reserved for platform moderators." },
    "لا توجد نزاعات في هذه الحالة حاليًا.": { fr: "Aucun litige dans cet état pour le moment.", en: "No disputes in this state right now." },
    "تفاصيل النزاع": { fr: "Détail du litige", en: "Dispute detail" },
    "النتيجة الحقيقية — اللاعب الأول": { fr: "Score réel — joueur 1", en: "Actual score — player 1" },
    "النتيجة الحقيقية — اللاعب الثاني": { fr: "Score réel — joueur 2", en: "Actual score — player 2" },
    "اعتماد النتيجة يحدّث التقييم والنقاط ويقفل النزاع نهائيًا، ولا يمكن التراجع عنه من هذه الصفحة.": { fr: "Valider le score met à jour le classement et les points et clôt définitivement le litige ; cette page ne permet pas de revenir en arrière.", en: "Approving the score updates the rating and points and closes the dispute for good; this page cannot undo it." },
    "إغلاق": { fr: "Fermer", en: "Close" },
    "اعتماد النتيجة وإنهاء النزاع": { fr: "Valider le score et clore le litige", en: "Approve the score and close the dispute" },
    "أدخل نتيجة صحيحة بأرقام غير سالبة.": { fr: "Saisissez un score valide avec des nombres positifs ou nuls.", en: "Enter a valid score using non-negative numbers." },
    "النتيجة المقدَّمة": { fr: "Score déclaré", en: "Submitted score" },
    "الأدلة المرفوعة": { fr: "Preuves déposées", en: "Uploaded evidence" },
    "سجل الثقة": { fr: "Historique de confiance", en: "Trust history" },
    "مراجعة وحسم": { fr: "Examiner et trancher", en: "Review and decide" },
    "لا إجراء متاح": { fr: "Aucune action disponible", en: "No action available" },
    "نزاع محسوم": { fr: "Litige tranché", en: "Dispute resolved" },
    "مرفقات الدليل": { fr: "Pièces justificatives", en: "Evidence attachments" },
    "أرسلها": { fr: "Soumis par", en: "Submitted by" },
    "اعترض عليها": { fr: "Contesté par", en: "Disputed by" },
    "مباراة موثّقة": { fr: "Match vérifié", en: "Verified match" },
    "نزاع مُقام": { fr: "Litige déposé", en: "Dispute filed" },
    "قرار إداري": { fr: "Décision de modération", en: "Moderation decision" },
    "نتيجة مُقدَّمة غير صحيحة": { fr: "Score déclaré incorrect", en: "Submitted score was incorrect" },
    "اعتراض غير مبرَّر": { fr: "Contestation injustifiée", en: "Unjustified dispute" },
    "جارٍ التحميل…": { fr: "Chargement…", en: "Loading…" },
    "صورة دليل النتيجة": { fr: "Photo de la preuve du score", en: "Score evidence image" },
    "تعذر تحميل الصورة.": { fr: "Impossible de charger l'image.", en: "Could not load the image." },
    "هذه إشارة مراجعة فقط وليست إدانة.": { fr: "Ceci est uniquement un signal d'examen, pas une condamnation.", en: "This is only a review signal, not a finding of wrongdoing." },
    "عرض الصورة": { fr: "Voir l'image", en: "View image" },
    "لا توجد صورة": { fr: "Aucune image", en: "No image" },
    "لا توجد أحداث مسجّلة بعد.": { fr: "Aucun événement enregistré pour le moment.", en: "No events recorded yet." },
    "تم اعتماد النتيجة وإنهاء النزاع.": { fr: "Score validé et litige clos.", en: "Score approved and dispute closed." },
    "تعذر تحميل قائمة النزاعات.": { fr: "Impossible de charger la liste des litiges.", en: "Could not load the dispute list." },
    "تعذر فتح تفاصيل النزاع.": { fr: "Impossible d'ouvrir le détail du litige.", en: "Could not open the dispute detail." },
    "تعذر تحميل سجل الثقة.": { fr: "Impossible de charger l'historique de confiance.", en: "Could not load the trust history." },
    "تعذر اعتماد النتيجة.": { fr: "Impossible de valider le score.", en: "Could not approve the score." },
    "افتح مراجعة نزاع أولًا لعرض سجل الثقة.": { fr: "Ouvrez d'abord l'examen d'un litige pour afficher l'historique de confiance.", en: "Open a dispute review first to see the trust history." },
    "عدد اللقاءات السابقة بين اللاعبَين في مباريات مكتملة": { fr: "Rencontres précédentes entre les deux joueurs en matchs terminés", en: "Previous meetings between the two players in completed matches" },
  };
